...
int main()
{
	...
	cout << "Length of the longest sequence: " << lp_finder.get_max_length() << " elements" << endl;
	cout << "Total number of characters in the sequence: " << lp_finder.get_max_length() * 4 + 2 << endl;
